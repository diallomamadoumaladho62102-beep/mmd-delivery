/**
 * MMD Signature Collection — push notification sound filenames (Expo / APNs).
 * Keep in sync with apps/mobile/assets/sounds/ and apps/web/public/sounds/.
 */
...
export type MmdPushSoundKey = keyof typeof MMD_PUSH_SOUNDS;

/** Map push data.type (or similar) to bundled custom sound. */
