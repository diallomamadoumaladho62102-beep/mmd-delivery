...
export const MONEY_OUT_MODEL = {
  ...
  driverBankPayout: "sunday_0400_america_new_york_full_available_to_bank_no_minimum",
  restaurantBankPayout:
    "sunday_0400_america_new_york_full_available_to_bank_no_minimum",
  sellerBankPayout: "sunday_0400_america_new_york_full_available_to_bank_no_minimum",
