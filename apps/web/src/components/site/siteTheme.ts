...
export const siteRootClass =
  "site-root min-h-screen antialiased";
...
export const siteCardClass =
  "h-full rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur-sm " +
  "transition-[border-color,box-shadow,transform] duration-300 motion-safe:hover:-translate-y-0.5 " +
  "motion-safe:hover:border-orange-400/30 motion-safe:hover:shadow-lg motion-safe:hover:shadow-orange-950/20 " +
  "motion-reduce:transition-none";

export const sitePrimaryBtnClass =
  "inline-flex min-h-11 items-center justify-center rounded-xl px-5 py-3 text-sm font-semibold " +
...
export const siteChipClass =
  "inline-flex items-center rounded-lg border border-orange-300/30 " +
  "bg-orange-500/15 px-3 py-1.5 text-sm font-medium text-orange-50 shadow-sm shadow-orange-950/20";
