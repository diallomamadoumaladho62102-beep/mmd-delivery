...
export default function RestaurantOrdersPage() {
  ...
  async function load() {
    ...
    if (!user) {
      setErr("Tu dois te connecter pour voir les commandes du restaurant.");
      setLoading(false);
      return;
    }
    ...
    // 3) récupérer les commandes de TON restaurant
      ...
      <header className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="px-3 py-1.5 rounded-lg border text-sm bg-gray-900 text-white hover:bg-black"
          >
            Profil restaurant
          </Link>
        </div>
