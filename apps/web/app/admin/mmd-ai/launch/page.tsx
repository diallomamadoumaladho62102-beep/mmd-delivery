        ...
        <div className="mx-auto max-w-6xl space-y-6 p-6">
          <header className="space-y-3">
            <div className="inline-flex rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-slate-600 shadow-sm">
              {t("MMD Delivery · MMD AI Launch Control")}
            </div>
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-slate-900">
                  {t("MMD AI Launch Control")}
                </h1>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <h2 className="text-base font-semibold text-slate-900">{t("Countries")}</h2>
              <input
                value={search}
                ...
                <table className="min-w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-slate-200 text-slate-500">
                      ...
                      <th className="py-2 pr-4">{t("AI Enabled")}</th>
                      <th className="py-2 pr-4">{t("Last Updated")}</th>
                      <th className="py-2 pr-4">{t("Updated By")}</th>
                  ...
                  <tbody>
                    {filteredCountries.map((row) => (
                      <tr key={row.country_code} className="border-b border-slate-100">
                        ...
                        <td className="py-3 pr-4 text-slate-500">{t("Country-wide")}</td>
                        ...
                        <td className="py-3">
                          {canEdit ? (
                            ...
                            <span className="text-slate-400">{t("Read-only")}</span>
                          )}
                        </td>
                      </tr>
                    ))}
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <h2 className="text-base font-semibold text-slate-900">{t("Regions / States")}</h2>
              <select
