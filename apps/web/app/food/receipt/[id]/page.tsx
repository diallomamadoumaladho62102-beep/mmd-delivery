...
export default function FoodOrderReceiptWebPage() {
  ...
  return (
    ...
    >
      <ReceiptPrintBar label={t("order.receipt.print")} />
      <header
        style={{
      ...
      >
        ...
        <div style={{ fontSize: 13 }}>
          {t("order.receipt.order")} {receipt.invoice.entity_number} ·{" "}
