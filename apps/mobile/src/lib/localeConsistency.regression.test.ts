...
const REQUIRED: Array<{ file: "common" | "extras"; key: string }> = [
  ...
  { file: "extras", key: "checkout.payment.title" },
  { file: "extras", key: "checkout.payment.card" },
  { file: "extras", key: "checkout.payment.applePay" },
  { file: "extras", key: "checkout.payment.canceled" },
  { file: "extras", key: "checkout.payment.failed" },
